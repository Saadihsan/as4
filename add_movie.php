    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-6">
                ...
                <form action="add_moive_script.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="relasing">movie releasing date</label>
                    ...
                    <div class="form-group">
                        <label for="upload">Select Movie Poster</label>
